...
const get_message_path = cname =>
  "https://us-central1-chat-server-4e7a5.cloudfunctions.net/v1/channels/" +
  cname +
  "/messages";
// "https://us-central1-chat-server-4e7a5.cloudfunctions.net/v1/channels/general/messages";
  ...
  [GET_CHANNELS]({ commit }) {
    async function fetch_api() {
      const response = await fetch(
        "https://us-central1-demoapp-1779c.cloudfunctions.net/v1/channels/"
      );
      const json = await response.json();
